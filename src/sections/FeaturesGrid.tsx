					...
					<div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
						<div className='col-span-2'>
							...
							<p className='text-xl lg:text-2xl text-zinc-400 mt-8'>
								Blockforge provides robust and secure infrastructure to support the next generation of decentralized
								applications.
							</p>
					...
					<div className='grid grid-cols-1 md:grid-cols-3 gap-8 '>
						...
						<div className='col-span-2'>
							...
							<div className='flex flex-col text-xl lg:text-2xl text-zinc-400 mt-6 gap-6'>
								<p>
									Blockforge is dedicated to supporting the evolution of Web3 applications by delivering the necessary
									infrastructure and security for Web3.
								</p>
								<p>
									Blockforge champions Web3 for everyone. As a decentralized blockchain scaling platform, Blockforge
									enables developers to create scalable, user-friendly dApps with low transaction costs, all while
