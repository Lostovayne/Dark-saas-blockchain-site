...
const cardData = [
  ...
  },
  {
    ...
    description: "Empower your applucations with decentralized data solutions, ensuring security and transparency at every step",
    color: "lime",
  },
  {
              ...
              <div className="relative z-0 p-8 md:p-10  max-w-xs md:max-w-md group" key={title}>
                ...
                <div className="flex justify-center -mt-28">
                  <div className="inline-flex relative">
                    ...
                    <img src={image} alt="Pill" className="size-40 group-hover:-translate-y-6 transition duration-300" />
                  </div>
                </div>
